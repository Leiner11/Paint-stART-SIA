               ...
               <div class="side-bar">
                  ...
                  <nav class="side-menu">
                     ...
                     <ul class="nav">
                        ...
                        <li><a href="/PaintstART_Files/html/userprofile/userprofile.php"><span class="fa fa-cog"></span> My Information</a></li>
                        <li><a href="../orderHistory(Client)/orderHistory.php"><span class="fa fa"></span> Order History</a></li>
                  ...
                  <form action="/PaintstART_Files/php/delete.php" class="form-horizontal" method="POST" id="deleteForm">
                     <fieldset class="fieldset">
                        ...
                        <div class="form-group">
                           <label for="new_username" label class="col-md-2 col-sm-3 col-xs-12 control-label">Enter Username</label>
                           <div class="col-md-10 col-sm-9 col-xs-12">
                              <input type="text" class="form-control" id="username" name="username" value="" required>
                           </div>
                        </div>
                        <div class="form-group">
                           <label for="current_password" label class="col-md-2 col-sm-3 col-xs-12 control-label">Enter Password</label>
                           <div class="col-md-10 col-sm-9 col-xs-12">
                        ...
                        <div class="form-group">
                           <label for="new_email" label class="col-md-2 col-sm-3 col-xs-12 control-label">Enter Email Address</label>
                           <div class="col-md-10 col-sm-9 col-xs-12">
