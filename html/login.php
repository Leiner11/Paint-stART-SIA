...
<body>
  <header>
    ...
    <nav class="navigation">
      ...
      <a href="/PaintstART_Files/html/album-client/ClientPortfolio.php">Digital Art Works</a>
  ...
  <script>
    // Automatically click the login button when the page loads
    document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('loginButton').click(); // Replace 'loginButton' with the actual ID of your login button
    });
  </script>
</body>
