...
<link rel="stylesheet" href="Receipt.css" media="screen">
  ...
  <body data-home-page="Contact-Curse360.html" data-home-page-title="Contact Curse360" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en"><header class="u-black u-clearfix u-header u-header" id="sec-4b1f"><div class="u-clearfix u-sheet u-sheet-1">
    <style> 
      input[type=text] {
        border: none;
        ...
        <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-custom-color-3 u-text-hover-custom-color-3" href="#" style="padding: 10px 20px;">Contact Curse360</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-custom-color-3 u-text-hover-custom-color-3" href="#" style="padding: 10px 20px;">Home</a>
</li></ul>
          </div>
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Contact Curse360</a>
            ...
            <div class="u-layout-row" style="">
              ...
              <div class="u-container-style u-layout-cell u-right-cell u-size-40 u-size-xs-60 u-layout-cell-2" src="">
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-align-center u-custom-font u-font-lato u-text u-text-default u-text-1"style="color: white;">Paid by <span style="font-weight: 700;" class="u-text-custom-color-3"></span><input type="text" id="SizenColor" name="Costbox1" value="Princess Diana Ariado" readonly style="color: #7b6ada;">
                  </h2>
                  ...
                  <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-3" >
                    <input type="text" id="SizenColor" name="TextBox1" value="Color and Size:" readonly></div>

                  <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-4" >
                    <input type="text" id="SizenColor" name="TextBox2" value="Colored and 8 x 8 Size" readonly></div>

                  <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-5" >
                    <input type="text" id="SizenColor" name="Costbox1" value="$89.00" readonly></div>

                  <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-6" >
                    <input type="text" id="SizenColor" name="textbox3" value="Additionals:" readonly></div>

                  <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-7" >
                    <input type="text" id="SizenColor" name="textbox4" value="Additional Accessories" readonly></div>

                  <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-8" >
                    <input type="text" id="SizenColor" name="Costbox2" value="$89.00" readonly></div>
                  ...
                  <div class="u-align-center u-text u-text-body-alt-color u-text-10" >
                    <input type="text" id="SizenColor" name="Costbox3" value="$89.00" readonly></div>
                    
                  <div class="u-align-center u-text u-text-body-alt-color u-text-11" >
                    <input type="text" id="SizenColor" name="Costbox4" value="1231412412" readonly></div>
                  ...
                  <a href="#" class="u-btn u-btn-round u-button-style u-hover-palette-3-light-3 u-palette-2-light-2 u-radius-50 u-text-grey-90 u-btn-2">More Arts</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <footer class="u-align-center u-clearfix u-footer u-gradient u-footer" id="sec-a700"><div class="u-clearfix u-sheet u-sheet-1">
