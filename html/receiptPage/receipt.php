      ...
      <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1">
        ...
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1">
            <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-custom-color-3 u-text-hover-custom-color-3" href="#" style="padding: 10px 20px;">Contact Curse360</a>
            </li>
          ...
          <div class="u-layout-row" style="">
            ...
            <div class="u-container-style u-layout-cell u-right-cell u-size-40 u-size-xs-60 u-layout-cell-2" src="">
              <div class="u-container-layout u-container-layout-2">
                <h2 class="u-align-center u-custom-font u-font-lato u-text u-text-default u-text-1" style="color: white;">Receipt for <span style="font-weight: 700;" class="u-text-custom-color-3"></span><input type="text" id="SizenColor" name="Costbox1" value="" readonly style="color: #7b6ada;">
                </h2>
                ...
                <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-4">
                  <input type="text" id="artType" name="artType" value="" readonly>
                </div>

                <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-5">
                  <input type="text" id="artTypeCost" name="artTypeCost" value="$" readonly>
                </div>
                ...
                <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-7">
                  <input type="text" id="artStyleDetail" name="artStyleDetail" value="" readonly>
                </div>

                <div class="u-align-center u-custom-font u-font-lato u-text u-text-body-alt-color u-text-8">
                  <input type="text" id="artStyleDetailCost" name="artStyleDetailCost" value="$" readonly>
                </div>
